...
const TeamCard = ({ image1, image2, name1, name2, win1, win2, awards1, awards2 }) => {
    ...
    return (
        <div className='w-full h-full mb-[2vh] flex gap-[0.6vw]'>
            ...
            <div onMouseEnter={() => {
                ...
                setWin(win1)
                setN(awards1)
            }} onMouseLeave={handleMouseExit} className='group relative w-1/2 h-full bg-green-400 hover:rounded-[3vw] overflow-hidden transition-all'>
